...
class VapeUI(ctk.CTk):
    ...
    def update_minecraft_loop(self):
        ...
        self.after(700, self.update_minecraft_loop)
    ...
    def animate_loading_and_inject(self):
        ...
        self.canvas.itemconfigure(self.sublabel, text="")
        self.show_injected_messagebox()

    def show_injected_messagebox(self):
        CTkMessagebox(title="Success", message="Vape V4 Injected", icon="check", option_1="OK")
